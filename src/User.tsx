...
const ProjectInfo = [
    ...
    {
        title: "Excel Clone",
        desc: "Developed an Excel clone using HTML, CSS, and JavaScript, featuring core spreadsheet functionalities and an intuitive interface to mimic essential Excel operations",
        image: "Excel.png",
        live: false,
